...
public class WidgetsDataHelperTest {
    ...
    public void setUp() {
        ...
        WidgetData widgetData1 = new WidgetData((long) 1, "JEE Mains",
                "ENGINEERING_AND_ARCHITECTURE", null);
        widgetList.add(widgetData1);
        WidgetData widgetData2 = new WidgetData((long) 1882, "BITSAT",
                "ENGINEERING_AND_ARCHITECTURE", null);
        widgetList.add(widgetData2);
        WidgetData widgetData3 =
                new WidgetData((long) 453, "NATA", "ENGINEERING_AND_ARCHITECTURE", null);
        widgetList.add(widgetData3);
        WidgetData widgetData4 = new WidgetData((long) 789, "NEET", "MEDICINE_AND_ALLIED_SCIENCES"
                , null);
        widgetList.add(widgetData4);
        WidgetData widgetData5 =
                new WidgetData((long) 959, "AIIMS", "MEDICINE_AND_ALLIED_SCIENCES", null);
