...
public class LeadDetailHelper {
    ...
    public List<Long> getLeadEntities(EducationEntity educationEntity, Long userId, List<Long> entityIds) {
        List<Lead> leadList =
                leadRepository.fetchLeadByEntityTypeAndUserIdAndEntityIdIn(educationEntity, userId, entityIds);
