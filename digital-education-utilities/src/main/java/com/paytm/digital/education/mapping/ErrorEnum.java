...
public enum ErrorEnum {
    ...
    LON_INVALID(4057, "Please provide valid longitude in request.",
            BAD_REQUEST, 0),
    INVALID_SORT_FIELD(4058, "Invalid requested sort field(s).", BAD_REQUEST, 0),
    ENTITY_FIELD_MISSING_IN_DATABASE(4059, "Field - %s of entity - %s missing in database.",
            HttpStatus.SERVICE_UNAVAILABLE, 2),
    ERROR_IN_IMPORT(4059, "%s ", BAD_REQUEST, 1),
    INVALID_DATA_INGESTION_ENTITY(4060, "Requested entity : %s is not supported for data ingestion",
            BAD_REQUEST, 1),
