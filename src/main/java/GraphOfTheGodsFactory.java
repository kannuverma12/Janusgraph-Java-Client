...
public class GraphOfTheGodsFactory {
    ...
    public static JanusGraph create() {
        ...
        config.set("storage.cassandra.keyspace", "godgraph");
        config.set("storage.hostname", "127.0.0.1");
        //config.set("storage.version", "0.3.3");
        config.set("storage.root","/Users/b0216282/Documents/backups/cassandra/data");
...
//        JanusGraph g = JanusGraphFactory.open("/Users/b0216282/Documents/backups/git/janusgraph/src/main/resources/jp_spark.properties");
//        load(g);
//        g.close();
    //}
}