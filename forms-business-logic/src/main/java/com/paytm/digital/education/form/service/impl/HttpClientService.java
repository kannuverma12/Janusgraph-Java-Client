...
public class HttpClientService {
    ...
    @Autowired
    @Qualifier("personaRestTemplateQS")
    private PersonaRestTemplate personaRestTemplateQS;

    @Autowired
    @Qualifier("personaRestTemplateHeaders")
    private PersonaRestTemplate personaRestTemplateHeaders;
    ...
    public <T> ResponseEntity<T> makeHttpRequest(
        ...
        return personaRestTemplateQS.exchange(builder.toUriString(), httpMethod, httpEntity,
                returnType);
    }
    ...
    public <T> ResponseEntity<T> makeHttpRequestUsingAuthTokenInHeaders(
        ...
        HttpEntity<Object> httpEntity = new HttpEntity<Object>(body, headers);
        return personaRestTemplateHeaders.exchange(builder.toUriString(), httpMethod, httpEntity,
                returnType);
    }
}
