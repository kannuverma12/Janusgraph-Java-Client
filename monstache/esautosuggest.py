...
instiESData= es.search(index='education_search_institute_test', filter_path=['hits.hits._id','hits.hits._source.names', 'hits.hits._source.official_name', 'hits.hits._source.city', 'hits.hits._source.state', 'hits.hits._source.institute_id'],size=10000)
examESData= es.search(index='education_search_exam_test', filter_path=['hits.hits._id','hits.hits._source.names', 'hits.hits._source.official_name','hits.hits._source.exam_id'],size=10000)
