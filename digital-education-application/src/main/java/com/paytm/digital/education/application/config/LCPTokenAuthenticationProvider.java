...
import com.paytm.digital.education.admin.service.AuthorizationService;
...
public class LCPTokenAuthenticationProvider implements AuthenticationProvider {
    ...
    @Autowired
    public LCPTokenAuthenticationProvider(ExternalServiceAuthenticator externalServiceAuthenticator) {
    ...
    public Authentication authenticate(Authentication authentication) throws AuthenticationException {
        ...
        return authorizationService.authenticate(token.get(), authentication, externalServiceAuthenticator);
    }
