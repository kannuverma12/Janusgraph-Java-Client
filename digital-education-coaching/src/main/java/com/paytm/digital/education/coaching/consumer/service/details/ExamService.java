...
public class ExamService {
    ...
    public GetExamDetailsResponse getExamDetails(final long examId, final String urlDisplayKey) {
        ...
        Optional<Instance> nearestInstanceOptional = examInstanceHelper.getNearestInstance(
                exam.getInstances());
        Instance nearestInstance = nearestInstanceOptional.orElseGet(Instance::new);
