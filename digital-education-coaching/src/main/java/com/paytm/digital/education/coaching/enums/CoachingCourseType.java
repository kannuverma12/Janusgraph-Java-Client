...
import static com.paytm.digital.education.coaching.enums.DisplayHeadings.CLASSROOM_COURSE_DESCRIPTION;
import static com.paytm.digital.education.coaching.enums.DisplayHeadings.DISTANCE_LEARNING_DESCRIPTION;
import static com.paytm.digital.education.coaching.enums.DisplayHeadings.E_LEARNING_DESCRIPTION;
import static com.paytm.digital.education.coaching.enums.DisplayHeadings.TEST_SERIES_OFFLINE_DESCRIPTION;
import static com.paytm.digital.education.coaching.enums.DisplayHeadings.TEST_SERIES_ONLINE_DESCRIPTION;
...
public enum CoachingCourseType {
    ...
    CLASSROOM_COURSE(CourseType.CLASSROOM_COURSE,
            CoachingCourseTypeResponse.builder()
                    .description(CLASSROOM_COURSE_DESCRIPTION.getValue())
    ...
    DISTANCE_LEARNING(CourseType.DISTANCE_LEARNING,
            CoachingCourseTypeResponse.builder()
                    .description(DISTANCE_LEARNING_DESCRIPTION.getValue())
    ...
    TEST_SERIES_ONLINE(CourseType.TEST_SERIES_ONLINE,
            CoachingCourseTypeResponse.builder()
                    .description(TEST_SERIES_ONLINE_DESCRIPTION.getValue())
    ...
    TEST_SERIES_OFFLINE(CourseType.TEST_SERIES_OFFLINE,
            CoachingCourseTypeResponse.builder()
                    .description(TEST_SERIES_OFFLINE_DESCRIPTION.getValue())
                    .imageUrl(CommonUtil.getAbsoluteUrl("/Test_Series.svg",
                            SECTION))
    ...
    E_LEARNING(CourseType.E_LEARNING,
            CoachingCourseTypeResponse.builder()
                    .description(E_LEARNING_DESCRIPTION.getValue())
